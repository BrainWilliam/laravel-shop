            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                        ...
                        <select-district :init-value="{{ json_encode([$address->province, $address->city, $address->distinct]) }}" @change="onDistrictChanged" inline-template>
                        ...
                        <input type="hidden" name="distinct" v-model="district">
